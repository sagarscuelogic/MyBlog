 ...
 * @author Sagar Sutaia
 */
abstract class Myblog_Model_ModelAbstract
{
    /**
     * Mapper associated with this model instance
     *
     * @var Myblog_Model_ModelAbstract
     */
    protected $_mapper;
     ...
     *
     * @param array $data
     * @return Myblog_Model_ModelAbstract
     */
    ...
    public function setOptions(array $options)
    {
      ...
      *
      * @see Myblog_Model_Mapper_MapperAbstract::toArray()
      * @return object
      */
     ...
     *
     * @see Myblog_Model_DbTable_TableAbstract::getPrimaryKeyName()
     ...
     *
     * @param Myblog_Model_Mapper_MapperAbstract $mapper
     * @return Myblog_Model_ModelAbstract
     */
     ...
     *
     * @see Myblog_Model_Mapper_MapperAbstract::save()
     ...
     *
     * @param Myblog_Model_ModelAbstract $model Object to be compared to
     ...
     */
/*    public function diff(Myblog_Model_ModelAbstract $model,
     $ignorePrimaryKey = true, $relations = false, $load = true
        ...
        if ($relations) {
        	...
        	foreach($all_relations as $key => $property) {
        		...
        		if (is_null($value)) {
        			continue;
        		} elseif ($value instanceof Myblog_Model_ModelAbstract)  {
        			...
        			foreach ($value as $val) {
        				if ($val instanceof Myblog_Model_ModelAbstract) {
        		...
        		if (method_exists($model, $method)) {
        			...
        			if (is_null($other_value)) {
        				$other_value = array();
        			} elseif ($other_value instanceof Myblog_Model_ModelAbstract) {
