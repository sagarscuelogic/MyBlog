...
/**
 * Data Mapper implementation for Myblog_Model_Post
 *
 * @package Myblog_Model
 * @subpackage Mapper
 * @author Sagar Sutaia
 */
class Myblog_Model_Mapper_Post extends Myblog_Model_Mapper_MapperAbstract
{
    /**
     * Returns an array, keys are the field names.
     *
     * @param Myblog_Model_Post $model
     * @return array
     */
    public function toArray($model)
    {
        if (! $model instanceof Myblog_Model_Post) {
     ...
     *
     * @return Myblog_Model_DbTable_Post
     */
    public function getDbTable()
    {
        if ($this->_dbTable === null) {
            $this->setDbTable('Myblog_Model_DbTable_Post');
        }
     ...
     *
     * @param Myblog_Model_Post $model The model to delete
     ...
     */
    public function save(Myblog_Model_Post $model,
     ...
     * @param Myblog_Model_Post|null $model
     * @return Myblog_Model_Post|null The object provided or null if not found
     */
     ...
     * @param Myblog_Model_Post|null $entry The object to load the data into, or null to have one created
     * @return Myblog_Model_Post The model with the data provided
     */
    public function loadModel($data, $entry)
    {
        if ($entry === null) {
            $entry = new Myblog_Model_Post();
        }
