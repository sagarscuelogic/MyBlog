 ...
 * @author Sagar Sutaia
 */
abstract class Myblog_Model_Mapper_MapperAbstract
{
    /**
     * $_dbTable - instance of Myblog_Model_DbTable_TableAbstract
     *
     * @var Myblog_Model_DbTable_TableAbstract
     */
    protected $_dbTable;
     ...
     *
     * @param Myblog_Model_DbTable_TableAbstract $dbTable
     * @return Myblog_Model_Mapper_MapperAbstract
     */
     ...
     * @param Myblog_Model_ModelAbstract $model
    ...
    public function loadRelated($name, $model)
    {
        ...
        $obj = $row->$method('Myblog_Model_DbTable_' . $object_table_name, $rule);

        if (! empty($obj)) {
            $model_class = 'Myblog_Model_' . $object_table_name;
     ...
     *
     * @see Myblog_Model_DbTable_TableAbstract::countAllRows()
     ...
     *
     * @see Myblog_Model_DbTable_TableAbstract::countByQuery()
     ...
     *
     * @param Myblog_Model_ModelAbstract $model The model to delete
    ...
    {
        $adapter = new Myblog_Model_Paginator($select, $this);
     ...
     * @return array All Myblog_Model_ModelAbstract meeting the criteria
     */
     ...
     * @param Myblog_Model_ModelAbstract|null $model
     * @return Myblog_Model_ModelAbstract|null The matching models found or null if not found
     */
     ...
     *
     * @return Myblog_Model_DbTable_TableAbstract
     */
     ...
     *
     * @param new Myblog_Model_ModelAbstract $model
     * @return array
     */
     ...
     * @param Myblog_Model_ModelAbstract|null $entry The object to load the data into, or null to have one created
     */
